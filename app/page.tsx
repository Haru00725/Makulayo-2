...
export default function Home() {
  ...
  return (
    <main style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      {/* ============================================================
          THREE LAYERS — Static version (below the scroll track)
          ============================================================ */}
      <section
        id="layers"
      ...
      >
        <div className="max-w-5xl mx-auto px-5 md:px-8">
          ...
          <RevealGroup className="grid grid-cols-1 md:grid-cols-3">
            {[
              { label: "TOP", line: "Opens the room.", time: "First 15 minutes" },
              { label: "HEART", line: "Stays for hours.", time: "2 – 4 hours" },
              { label: "BASE", line: "Lingers on skin.", time: "6+ hours" },
            ].map((layer, i) => (
              <RevealItem
                key={layer.label}
                className="flex flex-col items-center text-center py-8 md:py-0 px-8"
                style={{
